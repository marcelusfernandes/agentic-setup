...
| `tests/run.mts` | discovers and runs every `tests/*.test.mts` file (79 cases total, split by area), against real throwaway repositories, nothing mocked; `npm test` or `npm run test:bun` |
